...
" =============================================================================
let s:base03 = [ '#151513', 244 ]
let s:base02 = [ '#30302c ', 245 ]
let s:base01 = [ '#4e4e43', 252 ]
let s:base00 = [ '#666656', 242  ]
let s:base0 = [ '#808070', 249 ]
let s:base1 = [ '#949484', 242 ]
let s:base2 = [ '#a8a897', 246 ]
let s:base3 = [ '#e8e8d3', 244 ]
...
let g:lightline#colorscheme#seoul256_light#palette = lightline#colorscheme#flatten(s:p)
